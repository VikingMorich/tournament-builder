...
// node_modules/react-brackets/node_modules/react-swipeable-views/lib/SwipeableViews.js
var require_SwipeableViews = __commonJS({
  "node_modules/react-brackets/node_modules/react-swipeable-views/lib/SwipeableViews.js"(exports) {
    "use strict";
    var _interopRequireDefault = require_interopRequireDefault();
    Object.defineProperty(exports, "__esModule", {
      value: true
...
// node_modules/react-brackets/node_modules/react-swipeable-views/lib/index.js
var require_lib2 = __commonJS({
  "node_modules/react-brackets/node_modules/react-swipeable-views/lib/index.js"(exports) {
    "use strict";
    var _interopRequireDefault = require_interopRequireDefault();
    Object.defineProperty(exports, "__esModule", {
      value: true
...
function useMedia(breakPoint) {
  var _useState = (0, import_react.useState)(typeof window !== "undefined" ? window.innerWidth <= breakPoint : false), isSmaller = _useState[0], setIsSmaller = _useState[1];
...
var renderTitle = function renderTitle2(title) {
  return import_react.default.createElement(RoundTitle, null, title);
};
var renderSeed = function renderSeed2(_ref) {
  ...
  return import_react.default.createElement(Seed, {
    mobileBreakpoint: breakpoint
  }, import_react.default.createElement(SeedItem, null, import_react.default.createElement("div", null, import_react.default.createElement(SeedTeam, null, ((_seed$teams = seed.teams) === null || _seed$teams === void 0 ? void 0 : (_seed$teams$ = _seed$teams[0]) === null || _seed$teams$ === void 0 ? void 0 : _seed$teams$.name) || "-----------"), import_react.default.createElement(SeedTeam, null, ((_seed$teams2 = seed.teams) === null || _seed$teams2 === void 0 ? void 0 : (_seed$teams2$ = _seed$teams2[1]) === null || _seed$teams2$ === void 0 ? void 0 : _seed$teams2$.name) || "-----------"))), import_react.default.createElement(SeedTime, {
    mobileBreakpoint: breakpoint
...
var SingleElimination = function SingleElimination2(_ref) {
  ...
  var data = rounds.map(function(round, roundIdx) {
    return import_react.default.createElement(Round, {
      key: round.title,
      className: roundClassName,
      mobileBreakpoint
    }, round.title && roundTitleComponent(round.title, roundIdx), import_react.default.createElement(SeedsList, null, round.seeds.map(function(seed, idx) {
  ...
  if (isResponsive) {
    ...
    return import_react.default.createElement(Bracket, {
      className: bracketClassName,
      dir: rtl ? "rtl" : "ltr",
      mobileBreakpoint
    }, import_react.default.createElement(import_react_swipeable_views.default, Object.assign({
      style: {
        minHeight: "500px"
      },
